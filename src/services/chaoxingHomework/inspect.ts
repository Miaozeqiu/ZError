import { CHAOXING_CLICK_HOMEWORK_TAB } from '../browserSkills/chaoxingHomework'
import { writeDebugDump } from '../agentDebugLog'
import { publishHomeworkCard } from '../browserAbstractions'
...
export const inspectChaoxingHomework = async (id: string, options?: { vision?: boolean }) => {
  ...
  const { enrichHomeworkWithVision, applyHomeworkVisionCache } = await import('../chaoxingHomeworkVision')
