import { askFrames, evalBrowserView, waitMs } from '../browser/eval'
import type { ChaoxingHomeworkInfo } from './homework'
import { runTextModel } from '../model/runner'
...
const startLocalCapture = async (id: string, index: number) => {
  const { CHAOXING_HOMEWORK_CAPTURE } = await import('../browser/skills/chaoxingHomework')
